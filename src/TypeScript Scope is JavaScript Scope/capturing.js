...
function mainFunc() {
    ...
    if (true) {
        ...
        var variableCapturedByTheInnerFunction_1 = "Available To The inner func";
        innerFunc = function () {
            return variableCapturedByTheInnerFunction_1;
...
function mainFunc2() {
    ...
    if (true) {
        //Env for capturing scope start here
        var variableCapturedByTheInnerFunction_2 = "Available To The inner func";
        innerFunc = function () {
            return variableCapturedByTheInnerFunction_2;
        }; // Env for capturing stop here;
        variableCapturedByTheInnerFunction_2 = "Changed";
    }
    return innerFunc();
}
